...
********************************************************************************
*/
component extends="coldbox.system.testing.BaseModelTest" model="cbvalidation.model.result.ValidationResult"{
	...
	function testAddError(){
		mockError = getMockBox().createMock("cbvalidation.model.result.ValidationError").init();
	...
	function testHasErrors(){
		...
		mockError = getMockBox().createMock("cbvalidation.model.result.ValidationError").init().configure("unit test","test");
		model.addError( mockError );
