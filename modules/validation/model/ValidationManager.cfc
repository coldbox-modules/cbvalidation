...
*/
import cbvalidation.model.*;
import cbvalidation.model.result.*;
component accessors="true" serialize="false" implements="IValidationManager"{
	...
	*/
	property name="resourceBundle" inject="coldbox:plugin:ResourceBundle" required="false";
	...
	*/
	ValidationManager function processRules(required cbvalidation.model.result.IValidationResult results, required struct rules, required any target, required any field){
	...
	*/
	cbvalidation.model.validators.IValidator function getValidator(required string validatorType, required any validationData){
		switch( arguments.validatorType ){
			case "required" 	: { return wirebox.getInstance("cbvalidation.model.validators.RequiredValidator"); }
			case "type" 		: { return wirebox.getInstance("cbvalidation.model.validators.TypeValidator"); }
			case "size" 		: { return wirebox.getInstance("cbvalidation.model.validators.SizeValidator"); }
			case "range" 		: { return wirebox.getInstance("cbvalidation.model.validators.RangeValidator"); }
			case "regex" 		: { return wirebox.getInstance("cbvalidation.model.validators.RegexValidator"); }
			case "sameAs" 		: { return wirebox.getInstance("cbvalidation.model.validators.SameAsValidator"); }
			case "sameAsNoCase" : { return wirebox.getInstance("cbvalidation.model.validators.SameAsNoCaseValidator"); }
			case "inList" 		: { return wirebox.getInstance("cbvalidation.model.validators.InListValidator"); }
			case "discrete" 	: { return wirebox.getInstance("cbvalidation.model.validators.DiscreteValidator"); }
			case "min" 			: { return wirebox.getInstance("cbvalidation.model.validators.MinValidator"); }
			case "max" 			: { return wirebox.getInstance("cbvalidation.model.validators.MaxValidator"); }
			case "udf" 			: { return wirebox.getInstance("cbvalidation.model.validators.UDFValidator"); }
			case "method" 		: { return wirebox.getInstance("cbvalidation.model.validators.MethodValidator"); }
			case "unique" 		: { return wirebox.getInstance("cbvalidation.model.validators.UniqueValidator"); }
			case "validator"	: {
