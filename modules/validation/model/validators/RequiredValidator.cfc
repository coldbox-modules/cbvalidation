...
*/
component accessors="true" implements="cbvalidation.model.validators.IValidator" singleton{
	...
	*/
	boolean function validate(required cbvalidation.model.result.IValidationResult validationResult, required any target, required string field, any targetValue, any validationData){
		// check
