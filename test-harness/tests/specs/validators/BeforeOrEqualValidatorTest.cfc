component extends="coldbox.system.testing.BaseModelTest" model="cbvalidation.models.validators.BeforeOrEqualValidator" {
	...
	function run( testResults, testBox ){
		...
		describe( "Before or equal date Validator", function(){
